...
const IngredientTable = ({ ingredients, loading, error, onDelete, onEdit }) => {
  if (loading) {
    return (
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="grid grid-cols-12 px-6 py-3 bg-[#f5f5f4] text-xs font-semibold text-gray-500 uppercase">
        ...
        <div className="col-span-3">Calorías</div>
      ...
      <div className="divide-y divide-gray-200">
        {ingredients.length === 0 ? (
          ...
          ingredients.map((ingredient) => (
            ...
            >
              <div className="col-span-1">#{ingredient.ing_id}</div>
              <div className="col-span-4 font-semibold">{ingredient.ing_name}</div>
              <div className="col-span-3">{ingredient.ing_calories}</div>
              <div className="col-span-2">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  {ingredient.ing_state ? 'Activo' : 'Inactivo'}
                </span>
              </div>
