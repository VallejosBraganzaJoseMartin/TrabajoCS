  ...
  return (
    <div className="hidden md:flex flex-col w-64 bg-white border-r">
      ...
      <div className="flex items-center justify-center h-16 border-b">
        <a href="/pizzas" className="text-gray-800 text-xl font-bold flex items-center">
      ...
      <div className="flex flex-col flex-grow p-4 space-y-2">
        <a href="/pizzas" className={`flex items-center px-4 py-2 text-sm font-semibold ${location === '/pizzas' ? 'text-red-600 border-l-4 border-red-500' : 'text-gray-500 border-l-4 border-transparent hover:text-red-600 hover:border-red-500 transition-colors duration-200'}`}>
        ...
        <a href="/ingredientes" className={`flex items-center px-4 py-2 text-sm font-semibold ${location === '/ingredientes' ? 'text-green-600 border-l-4 border-green-500' : 'text-gray-500 border-l-4 border-transparent hover:text-green-600 hover:border-green-500 transition-colors duration-200'}`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a href="#" className="flex items-center px-4 py-2 text-sm font-semibold text-gray-500 border-l-4 border-transparent hover:text-red-600 hover:border-red-500 transition-colors duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
