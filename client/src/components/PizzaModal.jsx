...
const PizzaModal = ({ open, onClose, onSubmit, pizza, mode = "create" }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 transition-opacity duration-300 p-4"
      onClick={onClose}
    >
      <div
        className="bg-white rounded-lg shadow-xl w-full max-w-md flex flex-col transform transition-all duration-300 scale-95 opacity-0 max-h-[90vh] overflow-hidden"
      ...
      >
        ...
        <div className="overflow-y-auto flex-grow">
          <form ref={formRef} onSubmit={onSubmit}>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-end p-4 bg-gray-50 border-t border-gray-200 rounded-b-lg gap-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="mb-2 sm:mb-0 sm:mr-3 px-4 py-2 rounded-md bg-white border border-gray-300 text-gray-800 hover:bg-gray-100 font-semibold transition-colors w-full sm:w-auto"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 rounded-md bg-red-500 text-white hover:bg-red-600 font-semibold shadow-sm hover:shadow-md transition-all w-full sm:w-auto"
                >
